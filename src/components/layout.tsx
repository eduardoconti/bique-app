    ...
    <Box sx={{ display: 'flex' }}>
      ...
      >
        ...
        <List>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={() => Router.push('/pedidos')}>
              <ListItemIcon>
                <DescriptionIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={() => Router.push('/produtos')}>
              <ListItemIcon>
                <CategoryIcon />
              </ListItemIcon>
          ...
          <ListItem disablePadding>
            <ListItemButton onClick={() => Router.push('/materia-prima')}>
              <ListItemIcon>
                <CategoryIcon />
              </ListItemIcon>
              <ListItemText primary={'Materia prima'} />
            </ListItemButton>
          </ListItem>

          <ListItem disablePadding>
            <ListItemButton onClick={() => Router.push('/clientes')}>
              <ListItemIcon>
                <PeopleIcon />
              </ListItemIcon>
